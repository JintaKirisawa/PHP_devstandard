    ...
    <div class="container bg-light border border-gray rounded" style="width:500px; padding:0; margin-top:10px;">
        <form action="" method="get" class="form" style="width:100%;">
            <table>
                ...
                <h5 class="text-center py-2 border border-gray">If Else Display Data Act-1</h5>
                ...
                <tbody style="margin-left:50px;">
                    <tr class="text-center">
                        ...
                        <td style="padding:10px;">
                            <input type="text" name="firstnumber" id="firstnumber" placeholder="First Number">
                        </td>
                    </tr>
                    <tr class="text-center">
                        <td style="padding:10px;">
                        ...
                        <td style="padding:10px;">
                            <input type="text" name="secondnumber" id="secondnumber" placeholder="Second Number">
                        </td>
                    </tr>
                </tbody>
...
if(isset($_GET['firstnumber']) && isset($_GET['secondnumber'])){
    ...
    echo "<div class='card card-body bg-primary text-light'>The sum is: $totalnumber";
}
