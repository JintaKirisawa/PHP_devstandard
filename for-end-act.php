...
<body>
    ...
    <div class="container p-0 text-center border border-gray rounded mt-2" style="width:350px;">
        <h3 class="bg-dark text-light p-3 rounded">Ends Width</h3>
        <form action="" method="post" class="bg-light">

            <input type="number" name="Number" class="border border-gray rounded d-inline-flex mt-2" placeholder="Enter Number!">
