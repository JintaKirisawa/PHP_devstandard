...
<body>
    ...
    <div class="container p-0 text-center border border-gray rounded mt-2" style="width:350px;">
        <h4 class="bg-dark text-light p-3 rounded">Increasing or Decreasing</h4>
        <form action="" method="post" class="bg-light">
            ...
            <input type="number" name="thirdNumber" class="border border-gray rounded d-inline-flex mt-2" placeholder=" Third Number">
...
function check($num1, $num2, $num3){
    if($num1 < $num2 && $num2 < $num3){
        echo "<div class='card card-body bg-dark text-light text-center mt-3'>Increasing";
    }
    else if($num1 > $num2 && $num2 > $num3){
        echo "<div class='card card-body bg-dark text-light text-center mt-3'>Decreasing";
    }
    else{
        echo "<div class='card card-body bg-dark text-light text-center mt-3'>Neither";
    }
}
