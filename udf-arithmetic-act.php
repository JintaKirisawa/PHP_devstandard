...
<body>
    ...
    <div class="container bg-light border border-gray rounded" style="width:500px; padding:0; margin-top:10px;">
        <form action="" method="get" class="form" style="width:100%;">
            ...
            <button class="btn btn-outline-none bg-primary text-light" type="submit" name="submit" style="margin:10px 0 20px; margin-left:200px;">Compute</button>
...
function ComputeAll($firstnumber, $secondnumber){
...
if(isset($_GET['submit'])){
    ...
    ComputeAll($firstnumber, $secondnumber);
}
